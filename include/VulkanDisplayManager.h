#ifndef __UWP__
#ifndef _VULKANDISPLAYMANAGER_H_
#define _VULKANDISPLAYMANAGER_H_
//Dem debug things
#ifdef _WIN32
	#ifdef _DEBUG
...
class VulkanDisplayManager : public DisplayManager
{
public:
    VulkanDisplayManager(int argc, char **argv);
    virtual ~VulkanDisplayManager();
