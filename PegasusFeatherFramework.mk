...
CXX      := /usr/bin/g++
CC       := /usr/bin/gcc
CXXFLAGS := `xml2-config --cflags` `sdl2-config --cflags`  -g -O0 -Wall $(Preprocessors)
...
$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(ObjectSuffix): src/OpenGLDisplayManager.cpp $(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ripper/Documents/shadesprototype/src/OpenGLDisplayManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(DependSuffix): src/OpenGLDisplayManager.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(DependSuffix) -MM src/OpenGLDisplayManager.cpp

$(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(PreprocessSuffix): src/OpenGLDisplayManager.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_OpenGLDisplayManager.cpp$(PreprocessSuffix) src/OpenGLDisplayManager.cpp
...
$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(ObjectSuffix): src/OpenGLES2DisplayManager.cpp $(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ripper/Documents/shadesprototype/src/OpenGLES2DisplayManager.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(DependSuffix): src/OpenGLES2DisplayManager.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(DependSuffix) -MM src/OpenGLES2DisplayManager.cpp

$(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(PreprocessSuffix): src/OpenGLES2DisplayManager.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_OpenGLES2DisplayManager.cpp$(PreprocessSuffix) src/OpenGLES2DisplayManager.cpp
